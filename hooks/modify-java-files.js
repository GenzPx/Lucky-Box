...
async function main() {
  ...
  const contentToAdd = {
    'SystemWebView.java': {
      'import': ['android.graphics.Rect', 'android.os.Build', 'android.text.InputType', 'android.view.ActionMode', 'android.view.inputmethod.InputConnection', 'android.view.inputmethod.EditorInfo', 'android.view.Menu', 'android.view.MenuItem', 'android.view.View'],
      'fields': [{
        type: 'int',
        name: 'type',
        modifier: 'private',
      ...
      methods: [{
        ...
        body: [`InputConnection ic = super.onCreateInputConnection(outAttrs);
        ...
        body: [`return suppressActionMode(super.startActionMode(wrapActionModeCallback(callback)));`],
        notation: '@Override'
      }, {
        name: 'startActionMode',
        modifier: 'public',
        ...
        body: [`return suppressActionMode(super.startActionMode(wrapActionModeCallback(callback), type));`],
        notation: '@Override'
      }, {
        ...
        body: [`return suppressActionMode(super.startActionModeForChild(originalView, wrapActionModeCallback(callback)));`],
        notation: '@Override'
      }, {
        name: 'startActionModeForChild',
        modifier: 'public',
        ...
        body: [`return suppressActionMode(super.startActionModeForChild(originalView, wrapActionModeCallback(callback), type));`],
        notation: '@Override'
      }, {
        ...
        body: [`if (!nativeContextMenuDisabled || callback == null) {
              return callback;
            }
        ...
        body: [`if (mode == null || !nativeContextMenuDisabled) {
              return mode;
            }
        ...
        body: [`if (mode == null || !nativeContextMenuDisabled || menu == null) {
              return;
            }
            menu.clear();
            mode.setTitle(null);
    ...
    'SystemWebViewEngine.java': {
      methods: [setInputTypeMethod, setNativeContextMenuDisabledMethod]
    },
    'CordovaWebViewEngine.java': {
      methods: [interfaceMethod, nativeContextMenuInterfaceMethod]
    },
    'CordovaWebView.java': {
      methods: [interfaceMethod, nativeContextMenuInterfaceMethod]
    },
  ...
  for (let file in contentToAdd) {
    ...
    if (contentToAddTo.methods) {
      ...
      if (isInterface(file, content)) {
        ...
        newContent = newContent.replace(regex, `$1${methods}\n$2`);
      } else {
