...
export default {
	...
	async open(page) {
		switch (page) {
			case "settings":
				(await import("settings/mainSettings")).default();
				break;
			case "help":
				(await import("settings/helpSettings")).default();
				break;
			case "problems":
				(await import("pages/problems/problems")).default();
				break;
			case "plugins":
				(await import("pages/plugins")).default();
				break;
			case "file_browser":
	...
	async "insert-color"() {
		...
		let res;
		try {
			const { default: color } = await import("dialogs/color");
...
`;
	...
	async welcome() {
		const { default: openWelcomeTab } = await import("pages/welcome/welcome");
		openWelcomeTab();
	},
