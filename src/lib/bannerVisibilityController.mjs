...
export class BannerVisibilityController {
  ...
  reconcile() {
    ...
    const pageRequestsBanner = this.#suppressions.size === 0 && activePage !== null && this.#registeredPages.has(activePage);
  ...
  #queueNativeVisibility(shouldShow) {
    ...
    this.#operation = this.#operation.catch(this.#onError).then(async () => {
