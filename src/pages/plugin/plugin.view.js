...
function LegacyEditorWarning({ unsupportedEditor }) {
	...
	return (
		<div className="legacy-editor-warning">
			<span className="icon info"></span>
			<span>
				{`Built for older upstream editor versions powered by ${oldEditor}. Install with caution; some features may behave unexpectedly in the current CodeMirror version.`}
			</span>
		</div>
	);
}
