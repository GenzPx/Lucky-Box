  ...
  class _PluginContext {
    ...
    grantedPermission(permission) {
      return new Promise((resolve, reject) => {
        exec(resolve, reject, "Tee", "grantedPermission", [this.uuid, permission]);
      });
    }
    listAllPermissions() {
      return new Promise((resolve, reject) => {
    ...
    getSecret(key, defaultValue = "") {
      return new Promise((resolve, reject) => {
        exec(resolve, reject, "Tee", "get_secret", [this.uuid, key, defaultValue]);
      });
    }
    setSecret(key, value) {
      return new Promise((resolve, reject) => {
    ...
    generate: async function (pluginId, pluginJson) {
      try {
        function requestToken(pluginId) {
          return new Promise((resolve, reject) => {
            exec(resolve, reject, "Tee", "requestToken", [pluginId, pluginJson]);
          });
        }
