import type { InstallCheckResult, LspRuntimeProvider, LspServerDefinition, TransportContext, TransportHandle } from "../types";
...
function createBuiltinWorkerTransport(server: LspServerDefinition, context: TransportContext): TransportHandle {
