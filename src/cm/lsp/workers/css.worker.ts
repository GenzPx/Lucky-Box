import { getCSSLanguageService, getLESSLanguageService, getSCSSLanguageService, type LanguageService, type Stylesheet } from "vscode-css-languageservice";
...
startWorkerServer(({
  ...
  function getStylesheet(document: TextDocument, service: LanguageService): Stylesheet {
  ...
  return {
    ...
    validate(document) {
      ...
      return service.doValidation(document, getStylesheet(document, service));
    },
    async request(method, params) {
      ...
      switch (method) {
        case "textDocument/completion":
          return service.doComplete2(document, request.position, stylesheet, documentContext);
        ...
        case "textDocument/definition":
          {
            const definition = service.findDefinition(document, request.position, stylesheet);
            return definition ? [definition] : null;
          }
        case "textDocument/references":
          return service.findReferences(document, request.position, stylesheet);
        case "textDocument/prepareRename":
          return service.prepareRename(document, request.position, stylesheet) ?? null;
        case "textDocument/rename":
          return service.doRename(document, request.position, request.newName, stylesheet);
        case "textDocument/documentHighlight":
          return service.findDocumentHighlights(document, request.position, stylesheet);
        case "textDocument/documentLink":
          return service.findDocumentLinks2(document, stylesheet, documentContext);
        case "textDocument/codeAction":
          return service.doCodeActions2(document, request.range!, request.context, stylesheet);
        case "textDocument/documentColor":
          return service.findDocumentColors(document, stylesheet);
        case "textDocument/colorPresentation":
          return service.getColorPresentations(document, stylesheet, request.color, request.range!);
        case "textDocument/foldingRange":
          return service.getFoldingRanges(document);
        case "textDocument/selectionRange":
          return service.getSelectionRanges(document, request.positions, stylesheet);
        default:
