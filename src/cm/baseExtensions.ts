...
import { crosshairCursor, drawSelection, dropCursor, highlightActiveLine, highlightActiveLineGutter, highlightSpecialChars, keymap, rectangularSelection, tooltips } from "@codemirror/view";
...
export default function createBaseExtensions(options: BaseExtensionOptions = {}): Extension[] {
  const {
    autoIndent = true,
    codeFolding = true,
  ...
  extensions.push(keymap.of([...(autoCloseBrackets ? closeBracketsKeymap : []), ...completionKeymap]));
