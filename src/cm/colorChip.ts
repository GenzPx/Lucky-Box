...
export function getColorChipPayload(el: HTMLElement | null | undefined): ColorChipPayload | undefined {
...
export class ColorChipWidget extends WidgetType {
  ...
  eq(other: ColorChipWidget): boolean {
    return other.payload.from === this.payload.from && other.payload.to === this.payload.to && other.payload.css === this.payload.css && other.payload.source === this.payload.source && other.payload.lspClient === this.payload.lspClient && (other.payload.pickerSeed || "") === (this.payload.pickerSeed || "");
  }
  toDOM(): HTMLElement {
...
export function colorChipDecoration(payload: ColorChipPayload): Range<Decoration> {
...
export function detectColorFormat(text: string): "hex" | "rgb" | "hsl" | "other" {
